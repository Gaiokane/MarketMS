...
namespace MarketMS.UI
{
    public partial class FrmGoods : Form
    {
        ...
        public TextBox pogid = new TextBox();
        public TextBox pogname = new TextBox();
        public ComboBox pogcid = new ComboBox();
        public ComboBox pogunit = new ComboBox();
        public TextBox pogbid = new TextBox();
        public TextBox pogprice = new TextBox();
        public TextBox pogminimuminventory = new TextBox();
        public Label gamount = new Label();
        ...
        #region datagridview行双击事件
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            pogid.Text = this.dataGridView1[0, this.dataGridView1.CurrentCell.RowIndex].Value.ToString();
            pogname.Text = this.dataGridView1[1, this.dataGridView1.CurrentCell.RowIndex].Value.ToString();
            pogcid.Text = this.dataGridView1[2, this.dataGridView1.CurrentCell.RowIndex].Value.ToString();
            pogunit.Text = this.dataGridView1[7, this.dataGridView1.CurrentCell.RowIndex].Value.ToString();
            pogbid.Text = this.dataGridView1[4, this.dataGridView1.CurrentCell.RowIndex].Value.ToString();
            pogprice.Text = this.dataGridView1[3, this.dataGridView1.CurrentCell.RowIndex].Value.ToString();
            pogminimuminventory.Text = this.dataGridView1[6, this.dataGridView1.CurrentCell.RowIndex].Value.ToString();
            gamount.Text = this.dataGridView1[5, this.dataGridView1.CurrentCell.RowIndex].Value.ToString();
            this.Close();
        }
        #endregion

        #region 按下ESC键关闭当前窗口
        private void FrmGoods_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == 27)
            {
                this.Close();
