<%@ Page Language="C#" AutoEventWireup="true" CodeFile="barcodepay.aspx.cs" Inherits="F2FPay.BarcodePay" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>条码支付请求API</title>
    <style>
*{
	margin:0;
	padding:0;
    ...
    <form id="Form1" runat="server" target ="_blank">
        <div id="main">
            <div id="head">
                ...
                <span class="title">支付宝条码支付API</span>
            </div>
            ...
            <div id="body" style="clear: left">
                <dl class="content">
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <asp:TextBox ID="WIDdynamic_id" name="WIDdynamic_id" runat="server"></asp:TextBox>
                        <span>例如285695700867367d
</span>
                    </dd>
                    <dt></dt>
                    <dd>
                        ...
                        <span class="new-btn-login-sp">
                            <asp:Button ID="BtnAlipay0" name="BtnAlipay" class="new-btn-login" Text="提交" Style="text-align: center; height: 20px;"
                                runat="server" OnClick="Alipay_RSA_Submit"/></span> </font></dd></dl>
            </div>
            <div id="foot">
                <ul class="foot-ul">
